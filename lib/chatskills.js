                        ...
                        if (token.toLowerCase() != word.toLowerCase()) {
                            ...
                            if ((tokenParts && tokenParts.length == 3) || (tokenParts2 && tokenParts2.length > 0)) {
                                ...
                                switch (type) {
                                    ...
                                    case 'DATE':
                                    case 'AMAZON.DATE': isValidType = word.match(/(0?[1-9]|1[012])[- /.](0?[1-9]|[12][0-9]|3[01])[- /.](19|20)?[0-9]{2}/); break; //word.match(/([0-3]?[0-9].[0-3]?[0-9].(?:[0-9]{2})?[0-9]{2})/); break; // http://stackoverflow.com/a/29648721/2596404
                                    case 'LITERAL':
